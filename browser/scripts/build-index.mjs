...
import { FAMILIES } from './vendor-records.mjs';

const here = dirname(fileURLToPath(import.meta.url));
// The browser's own copies of the records, one directory per family beside this script's parent.
const RECORDS = join(here, '..');
