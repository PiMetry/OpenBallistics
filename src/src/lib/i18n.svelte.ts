...
const en = {
  ...
  'bullets.lede':
    'Makers’ bullets, each drawn to scale from its own published measurements, and the cartridges it fits. A figure the maker does not publish is assumed from the bullet’s type, and said to be.',
  ...
  'bullets.fitsNote': 'Matched by diameter to the cartridge’s bullet diameter G1, within 0.06 mm.',
...
const de: Record<keyof typeof en, string> = {
  ...
  'bullets.lede':
    'Geschosse der Hersteller, jedes maßstäblich nach seinen veröffentlichten Maßen gezeichnet, und die Patronen, in die es passt. Ein Maß, das der Hersteller nicht veröffentlicht, wird aus der Geschossart angenommen und als angenommen ausgewiesen.',
  ...
  'bullets.fitsNote': 'Über den Durchmesser dem Geschossdurchmesser G1 der Patrone zugeordnet, auf 0,06 mm.',
