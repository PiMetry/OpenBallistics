...
const en = {
  ...
  'list.disputed': 'A reader found a fault',
  ...
  'verify.verifiedWithVote': 'verified, {approve} for and {reject} against',
  'verify.disputedWithVote': 'disputed, {approve} for and {reject} against',
  'verify.agreed': '{net} of {threshold} agreed',
  'verify.disputedCount': '{count} disputed',
  ...
  'record.verifyFacet': 'Verify {facet}',
...
const de: Record<keyof typeof en, string> = {
  ...
  'list.disagreement': 'Widerspruch',
  'list.disputed': 'Ein Leser hat einen Fehler gemeldet',
  ...
  'verify.verifiedWithVote': 'geprüft, {approve} dafür und {reject} dagegen',
  'verify.disputedWithVote': 'strittig, {approve} dafür und {reject} dagegen',
  'verify.agreed': '{net} von {threshold} zugestimmt',
  'verify.disputedCount': '{count} strittig',
  ...
  'record.verifyFacet': '{facet} prüfen',
